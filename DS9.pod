...
Commands sent to DS9 are sent as strings.  In previous versions of
B<Image::DS9>, many of the commands and subcommands were available as
Perl constants.  However, the resulting mass of constants wasn't well
structured.  They are available via the B<Image::DS9::OldConstants>
package.  They may be introduced in another form in future versions of
this package.
